...
public interface RecommendServiceAgent {
    ...
    final static String CHOOSE_SERVICE_PROMPT="You are an Azure expert, your responsibility is to recommend Azure services(Azure Spring Apps, Azure Jakarta EE, Azure App Service, Azure Kubernetes Service, Azure Container Apps) to deploy on for my Java app based provided report." +
